  ...
  return (
    ...
    >
      <div className="space-y-6 select-none" dir="rtl">
        {/* ==================== CARD 1: VIP GOLD THEME COLOR CUSTOMIZER ==================== */}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] font-semibold text-slate-400 mt-0.5">
                  اختيار لون الثيم والتوهج الرئيسي للنظام من بين 5 لوحات ألوان ملكية
                </p>
              </div>
            </div>

            {!isVipGold && (
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 text-[11px] font-black text-amber-800 dark:text-amber-300">
                <Lock className="w-3.5 h-3.5 text-amber-600" />
                <span>حصرية لباقة VIP جولد 👑</span>
              </div>
            )}
          </div>
            ...
            {COLOR_PRESETS.map((preset) => {
              ...
              return (
                ...
                >
                  ...
                  {!isVipGold && (
                    <div className="mt-2 pt-2 border-t border-slate-200/50 dark:border-slate-800 flex items-center gap-1 text-[10px] text-amber-700 dark:text-amber-400 font-bold">
                      <Lock className="w-3 h-3" />
                      <span>ترقية لـ VIP جولد</span>
                    </div>
                  )}
                </div>
              );
        ...
        <div className="bg-white dark:bg-[#131b2e] rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs space-y-4 transition-colors">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800/80 pb-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-xs font-black text-slate-900 dark:text-white">المؤثرات والنغمات الصوتية (Audio Sound Engine)</h3>
                <p className="text-[10px] font-semibold text-slate-400 mt-0.5">
                  التحكم في نغمات تأكيد مسح الباركود واعتماد الفواتير في الكاشير والمبيعات
                </p>
              </div>
            </div>
            ...
            >
              ...
              <span>اختبار النغمة الصوتية</span>
            </Button>
          </div>
